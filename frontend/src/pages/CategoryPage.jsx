  ...
  return (
    <section>
        <div className='p-2 bg-white shadow-md flex items-center justify-between'>
            ...
            <button onClick={()=>setOpenUploadCategory(true)} className='text-sm border-primary-200 border hover:bg-primary-200 px-3 py-1 rounded cursor-pointer '>Add Category</button>
        </div>
        {
