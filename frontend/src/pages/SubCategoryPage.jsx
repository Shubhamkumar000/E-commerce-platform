    ...
    <section className="w-full">
      <div className='p-4 bg-white shadow-sm flex flex-wrap items-center justify-between gap-3 rounded-t-2xl'>
        <div>
          ...
          <h2 className='mt-2 text-xl font-semibold text-slate-900'>Sub Category</h2>
        </div>
        <button onClick={()=>setOpenAddSubCategory(true)} className='text-sm border-emerald-200 text-emerald-700 border hover:bg-emerald-50 px-4 py-2 rounded-full cursor-pointer font-semibold'>Add Sub Category</button>
      </div>
      <div className="overflow-auto w-full rounded-b-2xl">
        <DisplayTable
        data={data}
        column={column}/>
      </div>
