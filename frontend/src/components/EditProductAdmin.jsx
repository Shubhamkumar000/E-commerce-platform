...
const EditProductAdmin = ({close, data : propsData , fetchProductData}) => {
  ...
  return (
    <section className="fixed top-0 right-0 bottom-0 left-0 bg-black/70 z-50 ">
          ...
          <div className="grid p-4">
            <form className="grid gap-2" onSubmit={handleSubmit}>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            ...
                            className="absolute bottom-0 right-0 p-1 bg-red-600 hover:bg-red-600 rounded text-white hidden group-hover:block"
                          >
              ...
              <div
                ...
                className="hover:bg-primary-200 bg-white py-1 px-3 w-26 font-semibold border
          border-primary-200 hover:text-neutral-900 cursor-pointer rounded"
              >
                Add Fields
              </div>
              <button className="bg-primary-100 hover:bg-primary-200 border py-2 rounded font-semibold">
                Update product
              </button>
            </form>
          </div>
