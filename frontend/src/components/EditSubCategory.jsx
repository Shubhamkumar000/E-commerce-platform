          ...
          <form className="my-3 grid gap-3" onSubmit={handleSubmitSubCategory}>
            <div>
              <div className="grid gap-1">
                ...
                name="name"
                className="p-3 bg-blue-50 outline-none focus-within:border-primary-200"
                />
              </div>
            </div>
            <div className="grid gap-1">
              <p>Image</p>
                ...
                <label htmlFor="uploadSubCategoryImage">
                  <div className="px-3 py-1 border cursor-pointer
                  border-primary-200 text-primary-200 rounded hover:bg-primary-100 hover:text-neutral-900 ">
                    Upload Image
                  </div>
                  <input
                  ...
                  <div className="flex flex-wrap gap-2 ">
                    {
                      subCategoryData.category.map((cat,index)=>{
                        return (
                          <p key={cat._id + index} className="bg-white shadow-md px-1 m-1 flex items-center gap-2">
                            {cat.name}
                              <IoClose size={20} onClick={()=>handleRemoveCategory(cat._id)} className="cursor-pointer hover:text-red-600"/>
                          </p>
                        )
                      })
                    }
